...
| Fireworks | `fireworks`, `fireworks-anthropic` | `openai-completions`, `anthropic-messages` | Generated metadata includes the Fire Pass Kimi K2.6 Turbo router for the OpenAI-compatible endpoint and Kimi K2.6 for the Anthropic-compatible Messages endpoint. |
