...
// Responses, Azure OpenAI Responses, and OpenAI Codex Responses. Chat
// Completions-compatible registration is also the path for local endpoints and
// routers described with sigma.OpenAICompatibleModel.
//
